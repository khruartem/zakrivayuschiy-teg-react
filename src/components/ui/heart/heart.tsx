...
import type { THeartUIProps } from "./types";
import styles from "./heart.module.css";
import clsx from "clsx";

export const HeartUI: FC<THeartUIProps> = ({ active, onClick }) => {
  return (
    <svg
      id="heart"
      viewBox="0 0 39 36"
      xmlns="http://www.w3.org/2000/svg"
      className={clsx(styles["like-icon"], active && styles["is-liked"])}
      aria-hidden="true"
      onClick={onClick}
    >
      <g id="heart" className={styles.heart}>
        <path
          id="heart"
